...
namespace PayRex.Web.QuestPdf
{
    ...
    public class BillingInvoicePdfGenerator
    {
        ...
        private void ComposeHeader(IContainer container, BillingInvoicePdfGeneratorOptions opts, DateTime now, int totalRecords, byte[]? logoBytes = null)
        {
        ...
        private void ComposeFooter(IContainer container, BillingInvoicePdfGeneratorOptions opts, DateTime now)
        {
            container.Column(c =>
            {
